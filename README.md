...
* **Frontend (Acesse o site):** [https://visionbank-front.vercel.app](https://visionbank-front.vercel.app)
* **Backend (API):** [https://visionbank-back.onrender.com](https://visionbank-back.onrender.com)

> ⚠️ **Nota:** Como o Backend está hospedado no plano gratuito do Render, a primeira requisição pode levar de **1 a 2 minutos** para "acordar" o servidor. Por favor, aguarde um pouco ao tentar logar pela primeira vez.
...
```bash
# Clone o repositório
git clone [https://github.com/Raphaelgg99/visionbank.git](https://github.com/SEU_USUARIO/NOME_DO_REPO_BACK.git)
